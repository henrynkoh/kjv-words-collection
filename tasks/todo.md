...
- **2025-03-19:** Part D “The End Times” `(1d)–(17d)` in `data/beginning-faith-part-d/` chunks; emit + `/beginning-faith` include A+B+C+D; `beginning-faith-part-d-source.txt` generated by emit.
- **2025-03-19:** `/beginning-faith` interactive explorer: click any `(Na)` title to show that Q&A block; optional URL hash `#12b`; Part D included in full-doc copy; collapsible plain-text area.
