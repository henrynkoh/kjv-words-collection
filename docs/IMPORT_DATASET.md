...
## Beginning Faith — Part A (Q&A + study notes)

- **Canonical text:** `data/beginning-faith-part-a-source.txt`.  
- **Google Docs–ready export:** run `npm run emit:beginning-faith-doc` → `public/beginning-faith-part-a-google-docs.txt`.  
